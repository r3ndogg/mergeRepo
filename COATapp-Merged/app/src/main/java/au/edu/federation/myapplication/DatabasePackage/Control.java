...
import au.edu.federation.myapplication.Time;
import au.edu.federation.myapplication.User;
...
public class Control {
    ...
    public static final String columnSleep = "sleep";
    public static final String columnMood = "mood";
    public static final String columnEnergy = "energy";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public static boolean setUser(Context context, int userID, String name, int achievementPoints)
    {
        UserRecordDatabase dataSource = new UserRecordDatabase(context);

        dataSource.open();
        Boolean success = dataSource.insertUserRow(userID, name, achievementPoints);
        dataSource.close();
    ...
    public static boolean updateWellbeingTableColumn(Context context, int feedback, String column)
    {
        ...
        dataSource.open();
                ...
                switch (column) {
                    ...
                    case columnSleep: {
                        success = dataSource.updateWellbeingTableColumn(feedback, currentDate, UserRecordMySQLiteHelper.COLUMN_SLEEP);
                        Log.d("updateWellbeingTable", "Wellbeing table updated1!");
                        break;
                    }

                    case columnMood: {
                        success = dataSource.updateWellbeingTableColumn(feedback, currentDate, UserRecordMySQLiteHelper.COLUMN_MOOD);
                        Log.d("updateWellbeingTable", "Wellbeing table updated1!");
                        break;
                    }

                    case columnEnergy: {
                        success = dataSource.updateWellbeingTableColumn(feedback, currentDate, UserRecordMySQLiteHelper.COLUMN_ENERGY);
                        Log.d("updateWellbeingTable", "Wellbeing table updated1!");
                        break;
                    }
                }
...
////////////////////////////////////////////////////////////////////////////////////////////////////
                                             ...
                                             String mealComments)
    {
        ...
        Boolean success = dataSource.insertDietTableRow(
                dataSource.retrieveUserRow().getUserID(), healthRating, mealType, picture,
