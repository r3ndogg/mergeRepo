...
import au.edu.federation.myapplication.AvatarPackage.AvatarGLSurfaceView;
import au.edu.federation.myapplication.AvatarPackage.AvatarRenderer;
...
///////////////////////////////////////////////////////////
    ...
    public void handleButtonPress(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.saveSleepButton: {
                Control.updateWellbeingTableColumn(this, sleepSeekBar.getProgress(), Control.columnSleep);

                displayInformationSavedToast(informationTypeSleep);
                clearAnsweredQuestion(sleepLayout);
                break; }

            case R.id.saveMoodButton: {
                Control.updateWellbeingTableColumn(this, moodSeekBar.getProgress(), Control.columnMood);

                displayInformationSavedToast(informationTypeMood);
                clearAnsweredQuestion(moodLayout);
                break; }

            case R.id.saveEnergyButton: {
                Control.updateWellbeingTableColumn(this, energySeekBar.getProgress(), Control.columnEnergy);
