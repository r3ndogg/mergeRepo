...
public class UserRecordMySQLiteHelper extends SQLiteOpenHelper
{
    ...
    public static final String COLUMN_LIQUIDS = "liquids";
    ...
    public static final String COLUMN_QUESTION_1 = "question1";
    public static final String COLUMN_QUESTION_2 = "question2";
    public static final String COLUMN_QUESTION_3 = "question3";
    public static final String COLUMN_QUESTION_4 = "question4";
    public static final String COLUMN_QUESTION_5 = "question5";
    ...
    private static final String DATABASE_CREATE_TABLE_DIET = "create table "
            ...
            + COLUMN_LIQUIDS + " integer not null, "
    ...
    private static final String DATABASE_CREATE_TABLE_WELLBEING = "create table "
            + TABLE_WELLBEING + "("
            + COLUMN_USER_ID + " integer not null, "
            + COLUMN_QUESTION_1 + " integer not null, "
            + COLUMN_QUESTION_2 + " integer not null, "
            + COLUMN_QUESTION_3 + " integer not null, "
            + COLUMN_QUESTION_4 + " integer not null, "
            + COLUMN_QUESTION_5 + " integer not null, "
            + COLUMN_DATE + " text not null, "
            + "PRIMARY KEY (" + COLUMN_USER_ID + ", " + COLUMN_DATE + ")"
            + "FOREIGN KEY (" + COLUMN_USER_ID + ") REFERENCES "+ TABLE_USER + "(" + COLUMN_USER_ID + "));";
    ...
    public void onCreate(SQLiteDatabase db)
    {
        ...
        //Insert user for test purposes
        //db.execSQL("INSERT INTO " + TABLE_USER + " (" + COLUMN_USER_ID + ", " + COLUMN_USER_NAME + ", " +
        //        COLUMN_ACHIEVEMENT_POINTS + ", " + COLUMN_GENDER + ")" + " VALUES (9999, 'Someone', 0, 'MALE');");
